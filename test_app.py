...
def test_basicTariff():
    #Test 10 exact minutes fee with 1 dollar per minute(no 15 minutes free policy applied)
...
def test_calculateFee():
    ...
    #Test hourly tariff
        #24 exat hours
    assert calculateFee(datetime(2020,9,2,5,20),datetime(2020,9,2,6,20),"hourly")==24
